...
function geocodeAddress() {
  const address = document.getElementById("onewayfrom").value;
	...
	<form action="loginpage.php" method="GET"  class="needs-validation " novalidate id="onewayformm" >
	 ...
	 <div class="row">
			<div class="col-lg-3 col-space">
					...
					<label >From</label>
					<input type="text" class="form-control w-100 from"value="" name="sourcecity" id="onewayfrom" autocomplete="off" placeholder="Source" required oninput="geocodeAddress()">
					<div id="onebox"></div>
			</div>
			<div class="col-lg-3 col-space" >
				<img src="images/bus-1.png" alt="bus"  class="fonticons">
