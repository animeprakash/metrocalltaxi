...
<?php
        ...
        if(isset($_POST["submit"])) {
			...
			header("Location:bookingpage.php?cusemail=".$cusemail."&phonenumber=".$cusmobile." ");
...
<div class="row">
	<div class="details col-sm-6">
		...
		<form action="bookingpage.php" method="POST"  class="needs-validation" novalidate id="" >
	...
	<div class="col-sm-4">
		<div class="bookingdetails">
			...
			<div class="bookingrow">
				...
				<div >	<?php echo $fromaddress;?> - <?php echo $toaddress;?> </div>
		    </div>	
			<div class="bookingrow">
