        ...
        if(isset($_POST["register"])) {
			...
			mysqli_query($con,$query);
				...
				if(mysqli_num_rows($resone)==TRUE & mysqli_num_rows($restwo)==TRUE){
					...
					echo 'alert("Already registered using this Email and Mobile number")';
					echo '</script>';									
				}				
				else if(mysqli_num_rows($resone)==TRUE){
					
					echo '<script language="javascript">';
					echo 'alert("Already registered using this E-mail")';
					echo '</script>';												
				}
				else if(mysqli_num_rows($restwo)==TRUE){
					
					echo '<script language="javascript">';
					echo 'alert("Already registered using this Mobile number")';
					echo '</script>';					
				}
				else
				{
					...
					header("Location:selectairporttaxi.php?sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."&useremail=".$useremail."&usermobile=".$usermobile." ");	
				}
		}	
?>
        ...
        <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="registerairport.php" method="POST">					
