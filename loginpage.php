...
<?php		session_start();
			...
			if(isset($_POST["login"])) {
				...
				$queryone = "SELECT * FROM userdetails WHERE useremail = '".$email."'";
				$result=mysqli_query($con,$queryone);			

				$querytwo = "SELECT username,userpassword FROM userdetails WHERE useremail = '".$email."'";
				...
				{
					echo "<script>alert('This E-mail Id not registered');window.location.href='loginpage.php?trip=".$trip."&sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."';</script>";					
				}
				...
				{
					echo "<script>alert('Password is incorrect');window.location.href='loginpage.php?trip=".$trip."&sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."';</script>";					
					...
					if($trip=='oneway')
					{
						header("Location:selectonewaycars.php?sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."&useremail=".$email."");	
					}
						...
						header("Location:selectlocaltaxi.php?sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."&useremail=".$email."");	
					}
					else if($trip=='airport'){
						header("Location:selectairporttaxi.php?sourcecity=".$sourcecity."&destinationcity=".$destinationcity."&fromdate=".$fromdate."&fromtime=".$fromtime."&todate=".$todate."&airporttrip=".$airporttrip."&airportaddress=".$airportaddress."&useremail=".$email." ");
					}
					else if($trip=='customer'){
						header("Location:customerdashboard.php?email=".$email."");
					}				
				}
            ...
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="loginpage.php" method="POST">
                        ...
                        <div class="text-center pt-4 text-muted">Don't have an account? <a href="register.php?trip=<?php echo $trip; ?>&sourcecity=<?php echo $sourcecity; ?>&destinationcity=<?php echo $destinationcity; ?>&fromdate=<?php echo $fromdate; ?>&fromtime=<?php echo $fromtime; ?>&todate=<?php echo $todate; ?>&airporttrip=<?php echo $airporttrip; ?>&airportaddress=<?php echo $airportaddress; ?>">Register</a> </div>
                         <div class="text-center pt-4 text-muted">Forgot password? <a href="forgotpassword.php?trip=<?php echo $trip; ?>&sourcecity=<?php echo $sourcecity; ?>&destinationcity=<?php echo $destinationcity; ?>&airportaddress=<?php echo $airportaddress; ?>&fromdate=<?php echo $fromdate; ?>&fromtime=<?php echo $fromtime; ?>&airporttrip=<?php echo $airporttrip; ?>&todate=<?php echo $todate; ?>">Click here</a> </div>
