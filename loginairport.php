...
<?php
			...
			if(isset($_POST["login"])) {
				...
				$querytwo = "SELECT * FROM userdetails WHERE userpassword = '".$password."'";
				$resulttwo=mysqli_query($con,$querytwo);

				if(mysqli_num_rows($result)==FALSE & mysqli_num_rows($resulttwo)==FALSE)
				{
					echo '<script language="javascript">';
					echo 'alert("Invalid E-mail and Password")';
					echo '</script>';					
				}
				else if(mysqli_num_rows($result)==FALSE)
				{
					echo '<script language="javascript">';
					echo 'alert("Invalid E-mail ID")';
					echo '</script>';
				}
				else if(mysqli_num_rows($resulttwo)==FALSE)
				{
					echo '<script language="javascript">';
        ...
        <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
            <div class="panel border bg-white">
                ...
                <div class="panel-body p-3">
                    <form action="loginairport.php" method="post">
                        ...
                        <div class="text-center pt-4 text-muted">Don't have an account? <a href="register.php?trip=airport&sourcecity=<?php echo $sourcecity; ?>&destinationcity=<?php echo $destinationcity; ?>&fromdate=<?php echo $fromdate; ?>&fromtime=<?php echo $fromtime; ?>&todate=<?php echo $todate; ?>&airporttrip=<?php echo $airporttrip; ?>&airportaddress=<?php echo $airportaddress; ?>">Register</a> </div>
                         <div class="text-center pt-4 text-muted">Forgot password? <a href="forgotpassword.php?trip=airport&sourcecity=<?php echo $sourcecity; ?>&destinationcity=<?php echo $destinationcity; ?>&airportaddress=<?php echo $airportaddress; ?>&fromdate=<?php echo $fromdate; ?>&fromtime=<?php echo $fromtime; ?>&airporttrip=<?php echo $airporttrip; ?>&todate=<?php echo $todate; ?>">Click here</a> </div>
