...
<section class="onewaysec" id="onewaysec">
	...
	<form action="selectairporttaxi.php" method="GET"  class="needs-validation" novalidate id="onewayformm" >
	 <div class="row">
			<div class="col-lg-3">
			  <label >From</label>
...
<div class="roundtripform" id="roundtripform">
	<form action="selectairporttaxi.php" method="GET" class="needs-validation w3-container" novalidate>
	  <div class="row">
			<div class="col-sm-2">
			  <label >From</label>
