<?php
				...
				$email=$_GET['email'];
				$sql="select distinct(cusid),fromaddress,toaddress,finalamount,fromdate,triptype from cancelbookings inner join bookings on customid=cusid where cusemail='".$email."'";
...
<div>
	<?php include("customernavbar.php");?>
		...
		<div class="btn-group" role="group" style="margin-top:2%;">
			...
			<a href="customercancel.php?email=<?php echo $email; ?>" class=""><button class="btn w3-blue"  style="border:1px solid #0096ff;font-size:100%;">Cancelled</button></a>
